...
| --- | --- | --- | --- |
| System check | passed | critical | reports\system_integrity_2026-05-31.md \| failed checks: 0 |
...
| Daily close artifact | passed | critical | reports\daily_close_2026-05-31.md |
| Area review freshness | passed | critical | reports\area_review_index_2026-05-31.md \| date: 2026-05-31 \| stale areas: 0 \| missing areas: 0 |
| Notification outbox readiness | passed | critical | 76 notification(s), invalid statuses: none |
...
| Boundary classification coverage | passed | critical | 186/186 status docs covered |
