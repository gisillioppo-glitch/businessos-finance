# Private Demo Script / Sketch MVP v0.2
...
| --- | --- | --- | --- |
| Executive sponsor | decision visibility, daily close, risk prioritization, and operator confidence. | Dashboard, Command Center, Daily Close, Release Readiness. | raw technical internals unless they ask for architecture review. |
| Operations owner | handoffs, owners, blockers, support signals, and day-by-day pilot rhythm. | Operations, Support, Pilot Day 1-5, Pilot Tracker. | over-positioning as an email or reporting tool. |
| Governance or security reviewer | approval gates, sensitivity controls, public/private boundaries, and system integrity. | Governance, Sensitivity, Delivery Approval, Surface Audit, Boundary Index. | suggesting autonomous external delivery without approval. |
| Pilot evaluator | narrow pilot scope, measurable proof, exit decision, and expansion readiness. | Pilot Plan, Pilot Tracker, Pilot Exit, Pilot Day 5, Expansion Prep. | making the pilot feel broader than the controlled operating lane. |
