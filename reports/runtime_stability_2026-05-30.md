...
| Check | Status | Detail |
| --- | --- | --- |
| System integrity | passed | reports\system_integrity_2026-05-30.md | failed: 0 | warnings: 0 |
| Release readiness | passed | reports\release_readiness_2026-05-30.md | status: ready_with_warnings | failed: 0 | warnings: 1 |
| Daily close artifact | passed | reports\daily_close_2026-05-30.md |
| Dashboard local response | passed | http://localhost:8501 returned 200 |
| Git working tree | warning | M reports/release_readiness_2026-05-30.md; M reports/system_integrity_2026-05-30.md |
