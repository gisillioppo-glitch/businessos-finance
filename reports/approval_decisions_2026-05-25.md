...
Pending approvals: 5  
Approved approvals: 5  
Rejected approvals: 5  
Cancelled approvals: 0  
Critical approvals: 0  
High approvals: 5  
Medium approvals: 10  
Low approvals: 0  
Decision approvals: 2  
...
Review high-priority approvals and confirm executive decision.

## Approval Decision Queue

| Priority | Status | Type | Approver | Requester | Source | Approval | Justification |
| --- | --- | --- | --- | --- | --- | --- | --- |
| high | pending | decision | Executive Owner | Operations Manager | pilot_expansion | Approve controlled pilot expansion | n/a |
...
| medium | pending | policy | Executive Owner | BusinessOS System | notifications | Approve notification delivery to Finance Manager | n/a |
| medium | pending | policy | Executive Owner | BusinessOS System | notifications | Approve notification delivery to Support Manager | n/a |
...
| medium | rejected | policy | Executive Owner | BusinessOS System | notifications | Approve notification delivery to Operations Manager | Demo mode rejected the first pending approval request pending a better resolution path. |
