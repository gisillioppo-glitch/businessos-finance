...
| Git working tree | warning | warning | M README.md; M docs/institutional-core-extraction-map-v0.1.md; M docs/os-core-contract-checklist-v0.1.md; M docs/os-core-package-opening-decision-v0.1-status.md; M reports/system_integrity_2026-05-28.md; ?? docs/os-core-package-boundary-manifest-v0.1-status.md |
