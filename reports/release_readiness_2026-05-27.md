...
| --- | --- | --- | --- |
| System check | passed | critical | reports\system_integrity_2026-05-27.md \| failed checks: 0 |
...
| Daily close artifact | passed | critical | reports\daily_close_2026-05-27.md |
...
| Notification outbox readiness | passed | critical | 60 notification(s), invalid statuses: none |
...
| Boundary classification coverage | passed | critical | 166/166 status docs covered |
| Git working tree | warning | warning | M reports/release_readiness_2026-05-27.md |
