...
| Boundary classification coverage | passed | 134/134 status docs covered |
| Git working tree | warning | M README.md; M docs/institutional-core-extraction-map-v0.1.md; ?? docs/os-core-demo-pilot-boundary-readiness-v0.1-status.md |
