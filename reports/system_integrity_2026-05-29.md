...
| Boundary classification coverage | passed | 172/172 status docs covered |
| Git working tree | warning | M README.md; M docs/institutional-core-extraction-map-v0.1.md; M docs/os-core-branch-adapter-contract-draft-v0.1-status.md; M docs/os-core-contract-checklist-v0.1.md; M docs/os-core-package-boundary-manifest-v0.1-status.md; ?? docs/os-core-adapter-schema-checklist-v0.1-status.md |
