...
| --- | --- | --- | --- |
| Private pilot plan | available | yes | reports\private_pilot_plan_2026-05-11.md |
| Executive daily close | available | yes | reports\daily_close_2026-05-11.md |
| Command center | available | yes | reports\command_center_2026-05-11.md |
| Executive evidence index | available | yes | reports\executive_evidence_index_2026-05-11.md |
| Notification delivery approval | available | no | reports\notification_delivery_approval_2026-05-11.md |
| System integrity | available | yes | reports\system_integrity_2026-05-11.md |
| Release readiness | available | no | reports\release_readiness_2026-05-11.md |
