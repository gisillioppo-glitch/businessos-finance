...
| --- | --- | --- | --- |
| System check | passed | critical | reports\system_integrity_2026-05-16.md \| failed checks: 0 |
...
| Daily close artifact | passed | critical | reports\daily_close_2026-05-16.md |
...
| Boundary classification coverage | passed | critical | 85/85 status docs covered |
| Git working tree | warning | warning | M reports/release_readiness_2026-05-16.md |
