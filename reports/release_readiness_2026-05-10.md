...
| Git working tree | warning | warning | M README.md; M app/system/integrity_check.py; M cli.py; M reports/system_integrity_2026-05-10.md; M scripts/smoke_test.py; ?? app/readiness/; ?? docs/release-readiness-mvp-v0.1-status.md; ?? reports/release_readiness_2026-05-10.md |
