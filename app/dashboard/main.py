...
def render_module_page(page, data):
    ...
    if page == "Alerts":
        ...
        with right:
            ...
            render_brief_item(day_4["start_confirmation_status"].replace("_", " ").title(), "Linked start confirmation")
            render_brief_item(day_4["start_confirmation_report"], "Start confirmation artifact")
            render_panel_end()
            ...
            confirmation_class = {
                ...
                "blocked": "red",
                "missing": "red",
            }.get(day_4["start_confirmation_status"], "gold")
            render_status_row(
                day_4["start_confirmation_status"].replace("_", " ").title(),
                day_4["start_confirmation_detail"],
                confirmation_class,
            )
            render_panel_end()
        ...
        with right:
            ...
            render_brief_item(prep["start_confirmation_status"].replace("_", " ").title(), "Linked start confirmation")
            render_brief_item(prep["start_confirmation_report"], "Start confirmation artifact")
            ...
            confirmation_class = {
                ...
                "blocked": "red",
                "missing": "red",
            }.get(prep["start_confirmation_status"], "gold")
            render_status_row(
                prep["start_confirmation_status"].replace("_", " ").title(),
                prep["start_confirmation_detail"],
                confirmation_class,
            )
            render_panel_end()
